...
const FacilityCard = ({ facility }) => {
  ...
  const location = facility.location || "Unknown Location";
  const availability =
    facility.availabilityStatus || "Unavailable";

  const imageUrl =
    facility.url ||
    "https://5.imimg.com/data5/SELLER/Default/2023/6/319644438/HZ/LO/QF/191318154/artificial-green-turf-grass-for-outdoor.jpeg";
